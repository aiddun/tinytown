...
const AccessToken = require('./agoraTokenCalc').AccessToken
const Priviledges = require('./agoraTokenCalc').priviledges
...
class RtcTokenBuilder {
  ...
  static buildTokenWithAccount(
    ...
    if (role == AgoraRole.ATTENDEE || role == AgoraRole.PUBLISHER || role == AgoraRole.ADMIN) {
...
module.exports.AgoraRole = AgoraRole;
